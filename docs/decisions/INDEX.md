...
| 2026-09-21 | D004 | — | The manifest was another shell's schema plus one reserved key | Two formats need a translator that drifts | That shell publishes a new schema version or renames a kind | Superseded by D011 | [Full](D004-manifest-schema-borrowed-from-another-shell.md) |
