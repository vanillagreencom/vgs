...
| 2026-08-15 | D009 | — | Keep the manifest's second reader; the grammar keeps one | An inventory taken from the audited party's own report is not a cross-check | A `--dump-manifest` gains a second consumer, or the two readers diverge | Active | [Full](D009-manifest-second-reader.md) |
