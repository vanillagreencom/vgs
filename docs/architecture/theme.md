...
- An uninstalled theme paints from `themes/thumbnails/<name>.jpg`, which ships with the core package that every install carries. See `catalog_preview_path` in the helper.
