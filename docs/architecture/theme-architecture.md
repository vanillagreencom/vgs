...
A rail of angled, overlapping shots with the selection opened out in the middle; arrow keys and the scroll wheel page, Enter applies, Esc cancels. Additive: the dash tabs and Settings pickers are untouched, and paging applies nothing — the desktop changes only on Enter.
