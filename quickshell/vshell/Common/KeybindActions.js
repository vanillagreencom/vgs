...
const ACTION_TYPES = [
    { id: "vgs", label: "VGS Action", icon: "widgets" },
...
const VGS_ACTIONS = [
    ...
    { id: "spawn vshell ipc call defaultApp calendar", label: "Default Calendar: Open" },
    { id: "spawn vshell ipc call defaultApp textEditor", label: "Default Text Editor: Open" },
    { id: "spawn vshell ipc call defaultApp pdfReader", label: "Default PDF Reader: Open" },
    ...
    { id: "spawn vshell ipc call notifications toggle", label: "Notifications: Toggle" },
    { id: "spawn vshell ipc call notifications open", label: "Notifications: Open" },
    { id: "spawn vshell ipc call notifications close", label: "Notifications: Close" },
    { id: "spawn vshell ipc call processlist toggle", label: "Task Manager: Toggle" },
    { id: "spawn vshell ipc call processlist open", label: "Task Manager: Open" },
    { id: "spawn vshell ipc call processlist close", label: "Task Manager: Close" },
    { id: "spawn vshell ipc call processlist focusOrToggle", label: "Task Manager: Focus or Toggle" },
    { id: "spawn vshell ipc call settings toggle", label: "Settings: Toggle" },
    { id: "spawn vshell ipc call settings open", label: "Settings: Open" },
    { id: "spawn vshell ipc call settings close", label: "Settings: Close" },
    { id: "spawn vshell ipc call settings focusOrToggle", label: "Settings: Focus or Toggle" },
    { id: "spawn vshell ipc call powermenu toggle", label: "Power Menu: Toggle" },
    { id: "spawn vshell ipc call powermenu open", label: "Power Menu: Open" },
    { id: "spawn vshell ipc call powermenu close", label: "Power Menu: Close" },
    { id: "spawn vshell ipc call control-center toggle", label: "Control Center: Toggle" },
    { id: "spawn vshell ipc call control-center open", label: "Control Center: Open" },
    { id: "spawn vshell ipc call control-center close", label: "Control Center: Close" },
    { id: "spawn vshell ipc call notepad toggle", label: "Notepad: Toggle" },
    { id: "spawn vshell ipc call notepad open", label: "Notepad: Open" },
    { id: "spawn vshell ipc call notepad close", label: "Notepad: Close" },
    { id: "spawn vshell ipc call notepad expand", label: "Notepad: Expand" },
    { id: "spawn vshell ipc call notepad collapse", label: "Notepad: Collapse" },
    { id: "spawn vshell ipc call notepad toggleExpand", label: "Notepad: Toggle Expand" },
    { id: "spawn vshell ipc call dash toggle \"\"", label: "Dashboard: Toggle" },
    { id: "spawn vshell ipc call dash open overview", label: "Dashboard: Overview" },
    { id: "spawn vshell ipc call dash open media", label: "Dashboard: Media" },
    { id: "spawn vshell ipc call dash open weather", label: "Dashboard: Weather" },
    { id: "spawn vshell ipc call dash wallpaper", label: "Wallpaper Browser" },
    { id: "spawn vshell ipc call wallpaper-switcher toggle", label: "Wallpaper Switcher: Toggle" },
    { id: "spawn vshell ipc call wallpaper-switcher open", label: "Wallpaper Switcher: Open" },
    { id: "spawn vshell ipc call wallpaper-switcher close", label: "Wallpaper Switcher: Close" },
    { id: "spawn vshell ipc call theme-switcher toggle", label: "Theme Switcher: Toggle" },
    { id: "spawn vshell ipc call theme-switcher open", label: "Theme Switcher: Open" },
    { id: "spawn vshell ipc call theme-switcher close", label: "Theme Switcher: Close" },
    { id: "spawn vshell ipc call file browse wallpaper", label: "File: Browse Wallpaper" },
    { id: "spawn vshell ipc call file browse profile", label: "File: Browse Profile" },
    { id: "spawn vshell ipc call color-picker toggle", label: "Color Picker: Toggle" },
    { id: "spawn vshell ipc call color-picker open", label: "Color Picker: Open" },
    { id: "spawn vshell ipc call color-picker close", label: "Color Picker: Close" },
    { id: "spawn vshell ipc call keybinds toggle niri", label: "Keybinds Cheatsheet: Toggle", compositor: "niri" },
    { id: "spawn vshell ipc call keybinds open niri", label: "Keybinds Cheatsheet: Open", compositor: "niri" },
    { id: "spawn vshell ipc call keybinds close", label: "Keybinds Cheatsheet: Close" },
    { id: "spawn vshell ipc call lock lock", label: "Lock Screen" },
    { id: "spawn vshell ipc call lock demo", label: "Lock Screen: Demo" },
    { id: "spawn vshell ipc call inhibit toggle", label: "Idle Inhibit: Toggle" },
    { id: "spawn vshell ipc call inhibit enable", label: "Idle Inhibit: Enable" },
    { id: "spawn vshell ipc call inhibit disable", label: "Idle Inhibit: Disable" },
    { id: "spawn vshell ipc call audio increment 5", label: "Volume Up" },
    { id: "spawn vshell ipc call audio increment 1", label: "Volume Up (1%)" },
    { id: "spawn vshell ipc call audio increment 5", label: "Volume Up (5%)" },
    { id: "spawn vshell ipc call audio increment 10", label: "Volume Up (10%)" },
    { id: "spawn vshell ipc call audio decrement 5", label: "Volume Down" },
    { id: "spawn vshell ipc call audio decrement 1", label: "Volume Down (1%)" },
    { id: "spawn vshell ipc call audio decrement 5", label: "Volume Down (5%)" },
    { id: "spawn vshell ipc call audio decrement 10", label: "Volume Down (10%)" },
    { id: "spawn vshell ipc call mpris increment 5", label: "Player Volume Up (5%)" },
    { id: "spawn vshell ipc call mpris decrement 5", label: "Player Volume Down (5%)" },
    { id: "spawn vshell ipc call audio mute", label: "Volume Mute Toggle" },
    { id: "spawn vshell ipc call mic mute", label: "Microphone Mute Toggle" },
    { id: "spawn vshell ipc call audio cycleoutput", label: "Audio Output: Cycle" },
    { id: "spawn vshell ipc call brightness increment 5 \"\"", label: "Brightness Up" },
    { id: "spawn vshell ipc call brightness increment 1 \"\"", label: "Brightness Up (1%)" },
    { id: "spawn vshell ipc call brightness increment 5 \"\"", label: "Brightness Up (5%)" },
    { id: "spawn vshell ipc call brightness increment 10 \"\"", label: "Brightness Up (10%)" },

    { id: "spawn vshell ipc call brightness decrement 5 \"\"", label: "Brightness Down" },
    { id: "spawn vshell ipc call brightness decrement 1 \"\"", label: "Brightness Down (1%)" },
    { id: "spawn vshell ipc call brightness decrement 5 \"\"", label: "Brightness Down (5%)" },
    { id: "spawn vshell ipc call brightness decrement 10 \"\"", label: "Brightness Down (10%)" },

    { id: "spawn vshell ipc call brightness toggleExponential \"\"", label: "Brightness: Toggle Exponential" },
    { id: "spawn vshell ipc call theme toggle", label: "Theme: Toggle Light/Dark" },
    { id: "spawn vshell ipc call theme light", label: "Theme: Light Mode" },
    { id: "spawn vshell ipc call theme dark", label: "Theme: Dark Mode" },
    { id: "spawn vshell ipc call night toggle", label: "Night Mode: Toggle" },
    { id: "spawn vshell ipc call night enable", label: "Night Mode: Enable" },
    { id: "spawn vshell ipc call night disable", label: "Night Mode: Disable" },
    { id: "spawn vshell ipc call bar toggle index 0", label: "Bar: Toggle (Primary)" },
    { id: "spawn vshell ipc call bar reveal index 0", label: "Bar: Reveal (Primary)" },
    { id: "spawn vshell ipc call bar hide index 0", label: "Bar: Hide (Primary)" },
    { id: "spawn vshell ipc call bar toggleReveal index 0", label: "Bar: Toggle Autohide Reveal (Primary)" },
    { id: "spawn vshell ipc call bar toggleAutoHide index 0", label: "Bar: Toggle Auto-Hide (Primary)" },
    { id: "spawn vshell ipc call bar autoHide index 0", label: "Bar: Enable Auto-Hide (Primary)" },
    { id: "spawn vshell ipc call bar manualHide index 0", label: "Bar: Disable Auto-Hide (Primary)" },
    { id: "spawn vshell ipc call dock toggle", label: "Dock: Toggle" },
    { id: "spawn vshell ipc call dock reveal", label: "Dock: Reveal" },
    { id: "spawn vshell ipc call dock hide", label: "Dock: Hide" },
    { id: "spawn vshell ipc call dock toggleAutoHide", label: "Dock: Toggle Auto-Hide" },
    { id: "spawn vshell ipc call dock autoHide", label: "Dock: Enable Auto-Hide" },
    { id: "spawn vshell ipc call dock manualHide", label: "Dock: Disable Auto-Hide" },
    { id: "spawn vshell ipc call mpris playPause", label: "Media: Play/Pause" },
    { id: "spawn vshell ipc call mpris play", label: "Media: Play" },
    { id: "spawn vshell ipc call mpris pause", label: "Media: Pause" },
    { id: "spawn vshell ipc call mpris previous", label: "Media: Previous Track" },
    { id: "spawn vshell ipc call mpris next", label: "Media: Next Track" },
    { id: "spawn vshell ipc call mpris stop", label: "Media: Stop" },
    { id: "spawn vshell ipc call niri screenshot", label: "Screenshot: Interactive", compositor: "niri" },
    { id: "spawn vshell ipc call niri screenshotScreen", label: "Screenshot: Full Screen", compositor: "niri" },
    { id: "spawn vshell ipc call niri screenshotWindow", label: "Screenshot: Window", compositor: "niri" },
    { id: "spawn vshell ipc call hypr toggleOverview", label: "Hyprland: Toggle Overview", compositor: "hyprland" },
    { id: "spawn vshell ipc call hypr openOverview", label: "Hyprland: Open Overview", compositor: "hyprland" },
    { id: "spawn vshell ipc call hypr closeOverview", label: "Hyprland: Close Overview", compositor: "hyprland" },
    { id: "spawn vshell ipc call wallpaper next", label: "Wallpaper: Next" },
    { id: "spawn vshell ipc call wallpaper prev", label: "Wallpaper: Previous" },
    { id: "spawn vshell ipc call workspace-rename open", label: "Workspace: Rename" }
];
...
const CATEGORY_ORDER = ["VGS", "Execute", "Workspace", "Tags", "Window", "Move/Resize", "Focus", "Move", "Layout", "Groups", "Monitor", "Scratchpad", "Screenshot", "System", "Pass-through", "Overview", "Alt-Tab", "Other"];
...
const VGS_ACTION_ARGS = {
    "audio increment": {
        base: "spawn vshell ipc call audio increment",
        args: [{ name: "amount", type: "number", label: "Amount %", placeholder: "5", default: "5" }]
    },
    "audio decrement": {
        base: "spawn vshell ipc call audio decrement",
        args: [{ name: "amount", type: "number", label: "Amount %", placeholder: "5", default: "5" }]
    },
    "player increment": {
        base: "spawn vshell ipc call mpris increment",
        args: [{ name: "amount", type: "number", label: "Amount %", placeholder: "5", default: "5" }]
    },
    "player decrement": {
        base: "spawn vshell ipc call mpris decrement",
        args: [{ name: "amount", type: "number", label: "Amount %", placeholder: "5", default: "5" }]
    },
    "brightness increment": {
        base: "spawn vshell ipc call brightness increment",
        args: [
    ...
    "brightness decrement": {
        base: "spawn vshell ipc call brightness decrement",
        args: [
            { name: "amount", type: "number", label: "Amount %", placeholder: "5", default: "5" },
            { name: "device", type: "text", label: "Device", placeholder: "leave empty for default", default: "" }
        ]
    ...
    "brightness toggleExponential": {
        base: "spawn vshell ipc call brightness toggleExponential",
        args: [
            { name: "device", type: "text", label: "Device", placeholder: "leave empty for default", default: "" }
        ]
    },
    "dash toggle": {
        base: "spawn vshell ipc call dash toggle",
        args: [
...
function getVgsAmountLabel(action) {
    var parsed = parseVgsActionArgs(action);
    var label = VGS_AMOUNT_LABELS[parsed.base];
    if (!label)
        return null;
...
function getVgsActionArgs() {
    return VGS_ACTION_ARGS;
}

function getVgsActions(isNiri, isHyprland) {
    const result = [];
    for (let i = 0; i < VGS_ACTIONS.length; i++) {
        const action = VGS_ACTIONS[i];
...
function findVgsAction(actionId) {
    for (let i = 0; i < VGS_ACTIONS.length; i++) {
        if (VGS_ACTIONS[i].id === actionId)
            return VGS_ACTIONS[i];
    }
    return null;
}
...
function getActionLabel(action, compositor) {
    ...
    var amountLabel = getVgsAmountLabel(action);
    if (amountLabel)
        return amountLabel;

    var vgsAct = findVgsAction(action);
    if (vgsAct)
        return vgsAct.label;
...
function getActionType(action) {
    if (!action)
        return "compositor";
    if (action.startsWith("spawn vshell ipc call "))
        return "vgs";
...
function getActionArgConfig(compositor, action) {
    ...
    for (var key in VGS_ACTION_ARGS) {
        if (action.startsWith(VGS_ACTION_ARGS[key].base))
            return { type: "vgs", base: key, config: VGS_ACTION_ARGS[key] };
    }
...
function parseVgsActionArgs(action) {
    if (!action)
        return { base: "", args: {} };

    for (var key in VGS_ACTION_ARGS) {
        var config = VGS_ACTION_ARGS[key];
...
function buildVgsAction(baseKey, args) {
    var config = VGS_ACTION_ARGS[baseKey];
    if (!config)
        return "";
