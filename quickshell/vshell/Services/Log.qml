...
Singleton {
    ...
    readonly property int level: _parseLevel(Quickshell.env("VGS_LOG_LEVEL"))
    readonly property string levelName: _levelName(level)

    readonly property string _logFilePath: Quickshell.env("VGS_LOG_FILE") || ""
    readonly property bool _useColor: !Quickshell.env("NO_COLOR") && Quickshell.env("VGS_LOG_NO_COLOR") !== "1"
