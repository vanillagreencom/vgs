...
Item {
    ...
    Rectangle {
        ...
        color: dropdownArea.containsMouse || dropdownMenu.visible ? Theme.surfaceContainerHigh : (root.usePopupTransparency ? Theme.readableSurface : Theme.surfaceContainer)
        border.color: dropdownMenu.visible ? Theme.primary : Theme.borderColor
    ...
    Popup {
        ...
        contentItem: Item {
            ...
            VgsSurfaceChrome {
                ...
                surfaceColor: contentSurface.surfaceColor
