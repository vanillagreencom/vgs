...
Rectangle {
    ...
    readonly property bool isActive: NetworkBackendService.vpnStateForUuid(profile?.uuid) === "activated"
    readonly property bool isConnecting: NetworkBackendService.isVpnConnectingUuid(profile?.uuid)
    readonly property bool hasError: !isConnecting && NetworkBackendService.vpnError !== "" && NetworkBackendService.vpnErrorUuid === (profile?.uuid ?? "")
    ...
    opacity: (NetworkBackendService.isBusy && !isConnecting) ? 0.5 : 1.0
    clip: true
    ...
    MouseArea {
        ...
        anchors.fill: parent
        hoverEnabled: true
        cursorShape: NetworkBackendService.isBusy ? Qt.BusyCursor : Qt.PointingHandCursor
        enabled: !NetworkBackendService.isBusy
        onClicked: NetworkBackendService.toggle(profile.uuid)
    }
    ...
    Column {
        ...
        Row {
            ...
            Column {
                ...
                StyledText {
                    text: root.isConnecting ? I18n.tr("Connecting...") : (root.hasError ? NetworkBackendService.vpnError : VPNService.getVpnTypeFromProfile(profile))
        ...
        Column {
            ...
            Flow {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        height: 32
                        radius: Math.max(0, Theme.controlRadius - 2)
            ...
            Column {
                ...
                StyledText {
                    text: root.hasError ? NetworkBackendService.vpnError : I18n.tr("Credentials")
                    font.pixelSize: Theme.fontSizeSmall
