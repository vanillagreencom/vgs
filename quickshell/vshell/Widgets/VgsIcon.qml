...
Item {
    ...
    // VGS vendors Material Symbols so icon rendering does not depend on another shell.
    FontLoader {
        id: materialSymbolsFont
        source: Qt.resolvedUrl("../assets/fonts/material-symbols/MaterialSymbolsRounded.ttf")
    }
