...
PanelWindow {
    id: root
    readonly property var log: Log.scoped("VgsOSD")

    property string blurNamespace: "vshell:osd"
    ...
    WlrLayershell.layer: LayerShell.fromEnv("VGS_OSD_LAYER", WlrLayer.Overlay, {
        "allow": ["top", "overlay"],
    ...
    Item {
        ...
        ElevationShadow {
            ...
            borderWidth: 0
            shadowEnabled: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("VGS_DISABLE_LAYER") !== "true" && Quickshell.env("VGS_DISABLE_LAYER") !== "1"
        }
