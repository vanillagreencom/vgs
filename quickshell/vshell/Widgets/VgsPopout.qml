...
Item {
    id: root
    readonly property var log: Log.scoped("VgsPopout")
    ...
    property var _resolvedBackend: standaloneComp
    ...
    function _triggerBarUsesOverlayLayer(targetScreen, barConfig) {
        return LayerShell.envUsesOverlay("VGS_BAR_LAYER", barConfig?.useOverlayLayer ?? false);
    }
