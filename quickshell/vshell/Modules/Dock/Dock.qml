...
Variants {
    ...
    delegate: PanelWindow {
        ...
        WlrLayershell.namespace: "vshell:dock"
        ...
        readonly property string dockEdge: SettingsData.dockPosition === SettingsData.Position.Top ? "top" : SettingsData.dockPosition === SettingsData.Position.Bottom ? "bottom" : SettingsData.dockPosition === SettingsData.Position.Left ? "left" : "right"
        readonly property real surfaceRadius: Theme.cornerRadius
        readonly property color surfaceColor: Theme.withAlpha(Theme.surfaceContainer, backgroundTransparency)
        readonly property color surfaceBorderColor: BlurService.borderColor
        readonly property real surfaceBorderWidth: BlurService.borderWidth
        ...
        readonly property bool effectiveBlurEnabled: true
        ...
        readonly property bool usesOverlayLayer: SettingsData.dockUseOverlayLayer
                ...
                Item {
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            border.width: SettingsData.dockBorderEnabled ? dock.surfaceBorderWidth : 0
                            z: 100
                        }
                    }
