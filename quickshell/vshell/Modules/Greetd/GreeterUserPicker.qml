...
Item {
    ...
    readonly property int autoLoginRowHeight: 64
    ...
    readonly property int autoLoginBlockHeight: autoLoginVisible ? autoLoginRowHeight + Theme.spacingXS : 0
    ...
    Column {
        ...
        Rectangle {
            width: parent.width
            height: root.autoLoginRowHeight
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        Layout.fillWidth: true
                        text: I18n.tr("Enable auto-login after this login")
                        color: Theme.surfaceText
                        font.pixelSize: Theme.fontSizeMedium
                        elide: Text.ElideRight
                    }
                    ...
                    StyledText {
                        Layout.fillWidth: true
                        text: I18n.tr("Next boot skips the greeter password for this user")
                        color: Theme.warning
