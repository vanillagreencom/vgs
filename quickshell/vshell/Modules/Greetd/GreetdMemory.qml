...
Singleton {
    ...
    readonly property bool rememberLastSession: GreetdEnv.readBoolOverride(Quickshell.env, ["VSHELL_GREET_REMEMBER_LAST_SESSION", "VSHELL_SAVE_SESSION"], true)
    readonly property bool rememberLastUser: GreetdEnv.readBoolOverride(Quickshell.env, ["VSHELL_GREET_REMEMBER_LAST_USER", "VSHELL_SAVE_USERNAME"], true)
