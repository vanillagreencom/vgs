...
Item {
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "vshell:desktop-widget:" + root.pluginId + (root.instanceId ? ":" + root.instanceId : "")
        WlrLayershell.layer: {
        ...
        VgsFocusGrab {
            wanted: CompositorService.isHyprland && root.isInteracting
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            WlrLayershell.namespace: "vshell:desktop-widget-preview"
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            WlrLayershell.namespace: "vshell:desktop-widget-grid"
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            WlrLayershell.namespace: "vshell:desktop-widget-helper"
