...
Popup {
    ...
    function copyPid() {
        if (processData)
            Quickshell.execDetached([Paths.vshellCli, "cl", "copy", processData.pid.toString()]);
        close();
    }
    ...
    function copyName() {
        if (processData) {
            ...
            Quickshell.execDetached([Paths.vshellCli, "cl", "copy", name]);
        }
        close();
    }
    ...
    function copyFullCommand() {
        if (processData) {
            ...
            Quickshell.execDetached([Paths.vshellCli, "cl", "copy", fullCmd]);
        }
        close();
    }
