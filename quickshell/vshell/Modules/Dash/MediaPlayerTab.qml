    ...
    Item {
        ...
        Item {
            ...
            MultiEffect {
                ...
                blur: 0.8
                saturation: -0.2
                // Push the art toward the theme's surface luminance so text
                // keeps contrast: darken for dark mode, brighten for light.
                brightness: Theme.isLightMode ? 0.25 : -0.25
            }
        }
        ...
        Rectangle {
            ...
            radius: Theme.cornerRadius
            color: Theme.surface
            // Light surfaces need a thicker scrim over artwork for label contrast.
            opacity: Theme.isLightMode ? 0.5 : 0.3
        }
    }
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                ElevationShadow {
                                    ...
                                    shadowOpacity: Theme.popupShadowOpacity(Theme.elevationLevel1 && Theme.elevationLevel1.alpha !== undefined ? Theme.elevationLevel1.alpha : 0.2)
