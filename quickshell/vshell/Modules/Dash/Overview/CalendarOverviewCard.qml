...
Rectangle {
    ...
    Column {
        ...
        Rectangle {
            id: vgsWarning
            width: parent.width
            visible: CalendarService && CalendarService.vgsNeedsLaunch
            ...
            Row {
                ...
                StyledText {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    text: (CalendarService && CalendarService.vgsBinaryExists) ? I18n.tr("VGS Calendar isn't running") : I18n.tr("VGS Calendar isn't installed")
                ...
                VgsButton {
                    id: launchButton
                    anchors.verticalCenter: parent.verticalCenter
                    visible: CalendarService && CalendarService.vgsBinaryExists
                    text: I18n.tr("Launch")
                    buttonHeight: 26
                    backgroundColor: Theme.primary
                    textColor: Theme.primaryText
                    onClicked: CalendarService.launchVgsCalendar()
                }
            }
        }
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        Rectangle {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            radius: Theme.cornerRadius
                            color: deleteMouseArea.containsMouse ? (taskItem.isEditing ? Theme.primaryHover : Theme.withAlpha(Theme.error, 0.15)) : Theme.withAlpha(Theme.error, 0)
                            visible: modelData && modelData.id && modelData.id.startsWith("task_")
                            ...
                            VgsIcon {
                                ...
                                size: 14
                                color: deleteMouseArea.containsMouse ? (taskItem.isEditing ? Theme.primary : Theme.error) : Theme.onSurface_38
                            }
