...
Item {
    ...
    function dashTabIndexForWidget(widgetId) {
        switch (widgetId) {
        case "clock":
    ...
    function _loaderForWidgetId(widgetId) {
        ...
        case "music":
        case "weather":
            return PopoutService.dashPopoutLoader;
        case "cpuUsage":
        case "memUsage":
        case "cpuTemp":
        case "gpuTemp":
    ...
    function openHoverPopoutForHit(hit) {
        ...
        case "weather":
            {
                const tabIndex = dashTabIndexForWidget(widgetId);
                return barContent.openWidgetPopout(Object.assign({}, base, {
                    loader,
                    tabIndex,
    ...
    function checkHoverPopout(gx, gy) {
        ...
        if (hit.widgetId === "systemTray")
            ...
            triggerKey = dashTriggerSource(hit.section, dashTabIndexForWidget(hit.widgetId));
