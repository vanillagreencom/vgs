...
BasePill {
    ...
    readonly property var hiddenTrayIds: {
        const envValue = Quickshell.env("VGS_HIDE_TRAYIDS") || "";
    ...
    // Keep additional transport logic in bin/vshell_helper.py. See docs/decisions/D003-system-tray-transport.md.
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "vshell:tray-overflow-menu"
        color: "transparent"
    ...
    Component {
        ...
        Rectangle {
            ...
            PanelWindow {
                ...
                WlrLayershell.namespace: "vshell:tray-menu-window"
                ...
                Item {
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            height: 28
                            radius: Theme.cornerRadius
                            color: visibilityToggleArea.containsMouse ? Theme.elevatedRowColor : Theme.withAlpha(Theme.surfaceContainer, 0)
                        ...
                        Rectangle {
                            ...
                            height: 28
                            radius: Theme.cornerRadius
                            color: backArea.containsMouse ? Theme.elevatedRowColor : Theme.withAlpha(Theme.surfaceContainer, 0)
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                color: {
                                    ...
                                    return itemArea.containsMouse ? Theme.elevatedRowColor : Theme.withAlpha(Theme.surfaceContainer, 0);
                                }
                                ...
                                Row {
                                    ...
                                    StyledText {
                                        ...
                                        width: {
                                            let reserved = 0;
                                            if (buttonIndicator.visible)
                                                reserved += buttonIndicator.width + parent.spacing;
                                            if (entryIcon.visible)
                                                reserved += entryIcon.width + parent.spacing;
                                            if (submenuIndicator.visible)
                                                reserved += submenuIndicator.width + parent.spacing;
                                            return Math.max(0, parent.width - reserved);
                                        }
