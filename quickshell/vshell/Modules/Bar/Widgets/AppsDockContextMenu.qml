...
PanelWindow {
    ...
    WlrLayershell.namespace: "vshell:dock-context-menu"
    ...
    property bool isVgsWindow: appData?.appId === "org.quickshell" || appData?.appId === "com.vanillagreen.vshell"
    ...
    VgsSurfaceChrome {
        ...
        surfaceColor: Theme.popupSurfaceColor(Theme.surfaceContainer, false)
        ...
        Column {
            ...
            Rectangle {
                visible: {
                    ...
                    return !root.hidePin || (!root.isVgsWindow && root.desktopEntry && SessionService.nvidiaCommand);
                }
                width: parent.width
                height: 1
                color: Theme.outlineHeavy
            ...
            Rectangle {
                visible: {
                    const hasNvidia = !root.isVgsWindow && root.desktopEntry && SessionService.nvidiaCommand;
            ...
            Rectangle {
                visible: !root.isVgsWindow && root.desktopEntry && SessionService.nvidiaCommand
