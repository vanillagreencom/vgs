...
BasePill {
    ...
    function buildBaseItems() {
        ...
        sortedToplevels.forEach((toplevel, index) => {
            ...
            if (rawAppId === "org.quickshell" || rawAppId === "com.vanillagreen.vshell") {
                ...
                Rectangle {
                    ...
                    AppIconRenderer {
                        ...
                        iconValue: {
                            ...
                            if ((appId === "vgs_settings" || appId === "vgs_notepad" || appId === "vgs_sysmon") && modelData.coreAppData.cornerIcon) {
                    ...
                    IconImage {
                        ...
                        layer.enabled: appItem.appId === "org.quickshell" || appItem.appId === "com.vanillagreen.vshell"
                        layer.smooth: true
                        layer.mipmap: true
                    ...
                    onClicked: mouse => {
                        if (mouse.button === Qt.RightButton) {
                            ...
                            if (contextMenuLoader.item) {
                                ...
                                const shouldHidePin = modelData.appId === "org.quickshell" || modelData.appId === "com.vanillagreen.vshell";
                                const moddedId = Paths.moddedAppId(modelData.appId);
