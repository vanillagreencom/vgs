...
Item {
    ...
    function loadConfig() {
        configLoaded = false;
        configError = false;
        VGSBackendService.sendRequest("clipboard.getConfig", null, response => {
            if (response.error) {
                configError = true;
                return;
            }
    ...
    function saveConfig(key, value) {
        ...
        params[key] = value;
        saving = true;
        VGSBackendService.sendRequest("clipboard.setConfig", params, response => {
            saving = false;
            if (response.error) {
    ...
    VgsFlickable {
        ...
        Column {
            ...
            Rectangle {
                ...
                visible: !VGSBackendService.isConnected || configError
            ...
            SettingsCard {
                ...
                SettingsDropdownRow {
                    ...
                    description: I18n.tr("Oldest entries are removed beyond this limit")
                ...
                SettingsDropdownRow {
                    ...
                    description: I18n.tr("Entries larger than this are not saved to history")
            ...
            SettingsCard {
                ...
                SettingsToggleRow {
                    ...
                    description: I18n.tr("Delete all history when the clipboard service starts")
