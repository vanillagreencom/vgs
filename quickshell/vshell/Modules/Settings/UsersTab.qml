        ...
        Column {
                                ...
                                VgsActionButton {
                                    ...
                                    onClicked: {
                                        ...
                                        greeterToggleConfirm.showWithOptions({
                                            ...
                                            message: enableGreeter ? I18n.tr("Add \"%1\" to the %2 group? They must log out and back in, then run vshell greeter sync --profile to publish their login-screen theme.").arg(userRow.modelData.username).arg(UsersService.greeterGroup) : I18n.tr("Remove \"%1\" from the %2 group?").arg(userRow.modelData.username).arg(UsersService.greeterGroup),
            ...
            SettingsCard {
                ...
                SettingsToggleRow {
                    ...
                    text: I18n.tr("Administrator Privileges")
                ...
                SettingsToggleRow {
                    ...
                    text: I18n.tr("Greeter Login Access")
                    description: I18n.tr("Add the new user to the %1 group so they can run vshell greeter sync --profile").arg(UsersService.greeterGroup)
