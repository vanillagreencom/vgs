...
StyledRect {
    ...
    property bool hasSettings: pluginData && pluginSettingsPath !== ""
        ...
        Row {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    visible: VGSBackendService.pluginsAvailable && root.isLoaded && root.hasUpdate && !root.isSystemPlugin
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            VGSBackendService.update(currentPluginName, response => {
                                if (response.error) {
                ...
                Rectangle {
                    ...
                    visible: VGSBackendService.pluginsAvailable && !root.isSystemPlugin
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            const currentPluginName = root.pluginName;
                            VGSBackendService.uninstall(currentPluginName, response => {
                                if (response.error) {
