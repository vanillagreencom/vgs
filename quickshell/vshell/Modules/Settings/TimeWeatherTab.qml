        ...
        Column {
            ...
            SettingsCard {
                ...
                SettingsToggleRow {
                    ...
                    description: I18n.tr("21:30 instead of 9:30 PM")
            ...
            SettingsCard {
                ...
                SettingsDropdownRow {
                    tab: "time"
                    tags: ["calendar", "backend", "daemon", "khal", "vgs-calendar", "events"]
                    ...
                    description: {
                        ...
                        switch (resolved) {
                        case "vgs-calendar":
                            return I18n.tr("Using VGS Calendar%1", "calendar backend status").arg(CalendarService.isVgsActive && CalendarService.calendars.length > 0 ? "" : " (connecting…)");
                        case "khal":
                    ...
                    readonly property var _backendValues: ["auto", "khal", "vgs-calendar"]
                    readonly property var _backendLabels: [I18n.tr("Auto", "calendar backend option"), I18n.tr("khal", "calendar backend option"), I18n.tr("VGS Calendar", "calendar backend option")]
            ...
            SettingsCard {
                ...
                Column {
                    ...
                    SettingsToggleRow {
                        ...
                        description: I18n.tr("°F, mph, and inHg instead of °C, km/h, and hPa")
            ...
            SettingsCard {
                ...
                Column {
                    ...
                    StyledText {
                        text: I18n.tr("No weather data yet")
                        ...
                        Rectangle {
                            ...
                            Column {
                                ...
                                Column {
                                    ...
                                    StyledText {
                                        text: {
                                            const hourly = WeatherService.weather.hourlyForecast;
                                            const vis = (hourly && hourly.length > 0) ? hourly[0].visibility : 0;
                                            if (!vis)
                                                return "--";
                                            if (SettingsData.useFahrenheit)
