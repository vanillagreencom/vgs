        ...
        Column {
            ...
            SettingsCard {
                ...
                function mergedSavedWifiNetworks() {
                    ...
                    const supportsSavedWifiState = NetworkBackendService.supportsSavedWifiState || NetworkService.usingLegacy;
                    const result = [];
                    const seen = new Set();
                                        ...
                                        Column {
                                            ...
                                            Item {
                                                ...
                                                Column {
                                                    ...
                                                    Row {
                                                        spacing: Theme.spacingS
                                                        visible: (modelData.saved || isConnected) && (NetworkBackendService.supportsWifiAutoconnect || NetworkService.usingLegacy)
                        ...
                        delegate: Rectangle {
                                ...
                                Item {
                                    ...
                                    Row {
                                        ...
                                        VgsActionButton {
                                            iconName: "qr_code"
                                            buttonSize: 28
                                            visible: VGSBackendService.methods.includes("network.qrcode") && modelData.secured && !(modelData.enterprise || false)
                                            onClicked: {
                                                PopoutService.showWifiQRCodeModal(modelData.ssid);
                                            }
                                        }
                            ...
                            Menu {
                                ...
                                MenuItem {
                                    ...
                                    height: (NetworkBackendService.supportsWifiAutoconnect || NetworkService.usingLegacy) ? 32 : 0
                                    visible: NetworkBackendService.supportsWifiAutoconnect || NetworkService.usingLegacy
