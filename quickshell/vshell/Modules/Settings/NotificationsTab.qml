        ...
        Column {
            ...
            SettingsCard {
                ...
                Column {
                    ...
                    StyledText {
                        ...
                        wrapMode: Text.WordWrap
                        width: parent.width
                        horizontalAlignment: mutedRules.length > 0 ? Text.AlignLeft : Text.AlignHCenter
                        bottomPadding: Theme.spacingS
                    }
            ...
            SettingsCard {
                ...
                SettingsToggleRow {
                    ...
                    text: I18n.tr("History", "notification history toggle label")
                ...
                SettingsSliderRow {
                    ...
                    description: I18n.tr("How many notifications to keep", "notification history limit")
