...
Item {
    ...
    VgsFlickable {
        ...
        Column {
            ...
            SettingsCard {
                title: I18n.tr("Connected Displays")
                iconName: "monitor"
                width: parent.width
                                ...
                                Column {
                                    ...
                                    VgsToggle {
                                        ...
                                        onToggled: checked => {
                                            if (checked) {
                                                ...
                                                if (["bar", "dock", "notifications", "osd", "toast"].includes(cid) || cid.startsWith("bar:")) {
                                    ...
                                    VgsToggle {
                                        ...
                                        visible: {
                                            ...
                                            const cid = parent.componentId;
                                            const isRelevantComponent = ["bar", "dock", "notifications", "osd", "toast", "notepad"].includes(cid) || cid.startsWith("bar:");
                                    ...
                                    Column {
                                        ...
                                        Repeater {
                                            ...
                                            delegate: VgsToggle {
                                                ...
                                                description: screenData.width + "×" + screenData.height + " • " + (SettingsData.displayNameMode === "system" ? (screenData.model || I18n.tr("Unknown Model")) : screenData.name)
                                                checked: {
