...
Item {
    ...
    function getWindowRulesConfigPaths() {
        ...
        case "niri":
            return {
                ...
                "rulesFile": configDir + "/niri/vgs/windowrules.kdl",
                "grepPattern": 'include.*"vgs/windowrules.kdl"',
                "includeLine": 'include "vgs/windowrules.kdl"'
            };
        case "hyprland":
            return {
                "configFile": configDir + "/hypr/hyprland.lua",
                "rulesFile": configDir + "/hypr/vgs/windowrules.lua",
                "grepPattern": "vgs.windowrules",
                "includeLine": "require(\"vgs.windowrules\")"
            };
        case "mango":
            return {
                "configFile": configDir + "/mango/config.conf",
                "rulesFile": configDir + "/mango/vgs/windowrules.conf",
                "grepPattern": "vgs/windowrules.conf",
                "includeLine": "source=./vgs/windowrules.conf"
            };
        default:
            return null;
        }
            ...
            try {
                ...
                if (result.vgsStatus) {
                    windowRulesIncludeStatus = {
                        "exists": result.vgsStatus.exists,
                        "included": result.vgsStatus.included,
                        "configFormat": result.vgsStatus.configFormat ?? "",
                        "readOnly": result.vgsStatus.readOnly === true
                    };
                }
            } catch (e) {
                windowRules = [];
    ...
    function showHyprlandReadOnlyWarning() {
        ToastService.showWarning(I18n.tr("Hyprland edits are read-only"), I18n.tr("VGS can't edit Hyprland window rules from Settings; edit your Hyprland config directly."), "", "hyprland-migration");
    }
            ...
            StyledRect {
                ...
                Row {
                    ...
                    Column {
                        ...
                        StyledText {
                            text: warningBox.showLegacy ? I18n.tr("Hyprland edits are read-only") : I18n.tr("First Time Setup")
                        ...
                        StyledText {
                            text: warningBox.showLegacy ? I18n.tr("VGS can't edit Hyprland window rules from Settings; edit your Hyprland config directly.") : I18n.tr("Click Setup to create %1 and add the include to your compositor config").arg("vgs/windowrules")
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceVariantText
                            wrapMode: Text.WordWrap
                            width: parent.width
