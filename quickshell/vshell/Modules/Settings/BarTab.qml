...
Item {
    ...
    Connections {
        ...
        function onSelectedBarIdChanged() {
            if (barTab.selectedBarId !== SettingsUiState.selectedBarId)
                barTab.selectedBarId = SettingsUiState.selectedBarId;
        }
    }
    ...
    readonly property real insetPadAutoUI: selectedBarIsVertical ? Theme.spacingXS : Math.max(Theme.spacingXS, (selectedBarConfig?.innerPadding ?? 4) * 0.8)
        ...
        Column {
            ...
            SettingsCard {
                ...
                SettingsChoiceRow {
                    ...
                    model: SettingsData.barConfigs.map((config, index) => {
                        const name = config.name || I18n.tr("Bar %1").arg(index + 1);
                        return name.length > 14 ? name.slice(0, 13) + "\u2026" : name;
                    })
                    currentIndex: {
                        const index = SettingsData.barConfigs.findIndex(config => config.id === barTab.selectedBarId);
                        return Math.max(0, index);
                    }
                    onSelectionChanged: (index, selected) => {
                        if (!selected || index < 0 || index >= SettingsData.barConfigs.length)
                            return;
                        barTab.selectedBarId = SettingsData.barConfigs[index].id;
                    }
                }
            }
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            color: barTab.selectedBarId === modelData.id ? Theme.withAlpha(Theme.primary, 0.15) : Theme.surfaceVariant
                            border.width: barTab.selectedBarId === modelData.id ? 2 : 0
                            ...
                            Row {
                                ...
                                Column {
                                    ...
                                    StyledText {
                                        text: barCard.modelData.name || I18n.tr("Bar %1").arg(barCard.index + 1)
                                ...
                                VgsActionButton {
                                    ...
                                    onClicked: barTab.deleteBar(barCard.modelData.id)
                                }
                            }
                            ...
                            MouseArea {
                                ...
                                onClicked: barTab.selectedBarId = barCard.modelData.id
                            }
            ...
            SettingsCard {
                ...
                visible: !barTab.appearanceOnly && selectedBarId !== "default"
                ...
                SettingsToggleRow {
                    ...
                    onToggled: toggled => barTab.toggleBarEnabled(selectedBarId)
                }
            }
            ...
            SettingsCard {
                ...
                Column {
                    ...
                    SettingsToggleRow {
                        ...
                        onToggled: checked => {
                            if (checked) {
                                barTab.setBarScreenPreferences(selectedBarId, ["all"]);
                            } else {
                                barTab.setBarScreenPreferences(selectedBarId, []);
                            }
                        }
                    }
                    ...
                    SettingsToggleRow {
                        ...
                        onToggled: checked => barTab.setBarShowOnLastDisplay(selectedBarId, checked)
                    }
                        ...
                        Repeater {
                            ...
                            delegate: SettingsToggleRow {
                                ...
                                onToggled: checked => {
                                    ...
                                    barTab.setBarScreenPreferences(selectedBarId, newPrefs);
                                }
                            }
                        }
                    }
            ...
            SettingsCard {
                ...
                SettingsSliderRow {
                    ...
                    minimum: 0
                    maximum: 48
                    defaultValue: Math.round(barTab.insetPadAutoUI)
                    value: barTab.insetPadDisplayValue
                    onSliderDragFinished: finalValue => {
            ...
            SettingsToggleCard {
                ...
                visible: !barTab.appearanceOnly && selectedBarConfig?.enabled && (CompositorService.isNiri || CompositorService.isHyprland || CompositorService.isMango)
