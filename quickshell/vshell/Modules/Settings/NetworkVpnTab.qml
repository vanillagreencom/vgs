            ...
            SettingsCard {
                ...
                Column {
                    ...
                    StyledText {
                        ...
                        visible: !NetworkBackendService.vpnAvailable
                    }
                    ...
                    Row {
                        ...
                        StyledText {
                            text: {
                                if (!NetworkBackendService.connected)
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                visible: NetworkBackendService.connected
                                ...
                                MouseArea {
                                    ...
                                    onClicked: NetworkBackendService.disconnectAllActive()
                                }
                            }
                        }
                    }
                    ...
                    Item {
                        width: parent.width
                        height: 100
                        visible: NetworkBackendService.vpnAvailable && NetworkBackendService.profiles.length === 0
                    ...
                    Column {
                        ...
                        Repeater {
                            model: NetworkBackendService.profiles
                            ...
                            delegate: Rectangle {
                                ...
                                readonly property bool isActive: NetworkBackendService.isActiveUuid(modelData.uuid)
                                ...
                                opacity: NetworkBackendService.isBusy ? 0.6 : 1.0
                                clip: true
                                ...
                                MouseArea {
                                    ...
                                    cursorShape: NetworkBackendService.isBusy ? Qt.BusyCursor : Qt.PointingHandCursor
                                    enabled: !NetworkBackendService.isBusy
                                    onClicked: NetworkBackendService.toggle(modelData.uuid)
                                }
