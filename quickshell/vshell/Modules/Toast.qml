...
PanelWindow {
    ...
    WlrLayershell.namespace: "vshell:toast"
    ...
    Rectangle {
        ...
        color: {
            ...
            case ToastService.levelInfo:
                return Theme.popupSurfaceColor(Theme.surfaceContainer);
            default:
                return Theme.popupSurfaceColor(Theme.surfaceContainer);
            }
        }
                ...
                Column {
                    ...
                    Item {
                        ...
                        VgsActionButton {
                            ...
                            onClicked: {
                                Quickshell.execDetached([Paths.vshellCli, "cl", "copy", ToastService.currentDetails]);
                                showTooltip = true;
                    ...
                    Rectangle {
                        ...
                        VgsActionButton {
                            ...
                            onClicked: {
                                Quickshell.execDetached([Paths.vshellCli, "cl", "copy", ToastService.currentCommand]);
                                showTooltip = true;
                                tooltipTimer.start();
                            }
