        ...
        ErrorPill {
            ...
            primaryMessage: {
                if (!VGSBackendService.backendAvailable) {
                    return I18n.tr("VGS_SOCKET not available");
                }
                return I18n.tr("NM not supported");
            }
            secondaryMessage: I18n.tr("update vgs for NM integration.")
        }
    }
        ...
        ToggleButton {
            ...
            iconName: {
                ...
                case "darkMode":
                    return "contrast";
                case "idleInhibitor":
                    return SessionService.idleInhibited ? "coffee" : "bedtime";
                default:
                    return "help";
                }
            }
            ...
            iconRotation: {
                ...
                if (darkModeTransitionPending) {
                    return Theme.isLightMode ? 180 : 0;
                }
                return Theme.isLightMode ? 180 : 0;
            }
            ...
            onClicked: {
                ...
                case "darkMode":
                    {
                        const targetLightMode = !Theme.isLightMode;
                        Theme.screenTransition();
                        Theme.setLightMode(targetLightMode);
                        break;
                    }
                case "idleInhibitor":
                    {
