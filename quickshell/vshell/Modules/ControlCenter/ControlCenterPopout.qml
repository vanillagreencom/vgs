...
VgsPopout {
    ...
    function _contentTargetHeight() {
        ...
        return Math.max(300, naturalHeight + Theme.popoutPadding);
    }
    ...
    content: Component {
        Rectangle {
            ...
            readonly property real targetImplicitHeight: {
                ...
                return total + Theme.popoutPadding;
            }
                ...
                Column {
                    ...
                    DragDropGrid {
                        ...
                        maxPopoutHeight: {
                            ...
                            return screenHeight - 100 - Theme.popoutPadding - headerPane.implicitHeight - Theme.spacingS;
                        }
