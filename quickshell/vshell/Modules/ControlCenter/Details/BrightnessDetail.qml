...
Rectangle {
    ...
    function resolveCurrentDevice() {
        ...
        const monitor = devices.find(d => d.class === "ddc" || d.class === "apple");
        if (monitor)
            return monitor.name;
                                ...
                                Column {
                                    ...
                                    VgsIcon {
                                        name: {
                                            ...
                                            if (DisplayService.isDisplayBrightnessClass(deviceClass)) {
                                ...
                                Column {
                                    ...
                                    StyledText {
                                        text: {
                                            ...
                                            if (deviceClass === "apple")
                                                return I18n.tr("Apple display monitor");
                                            if (deviceClass === "leds")
