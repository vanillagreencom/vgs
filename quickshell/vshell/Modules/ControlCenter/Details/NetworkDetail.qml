...
Rectangle {
    ...
    property int currentPreferenceIndex: {
        if (NetworkService.backend !== "networkmanager" || (!NetworkBackendService.supportsNetworkPreference && !NetworkService.usingLegacy))
            return 1;
    ...
    Row {
        ...
        Row {
            ...
            VgsButtonGroup {
                ...
                anchors.verticalCenter: parent.verticalCenter
                visible: hasBothConnectionTypes && NetworkService.backend === "networkmanager" && (NetworkBackendService.supportsNetworkPreference || NetworkService.usingLegacy)
                buttonHeight: 28
    ...
    VgsFlickable {
        ...
        anchors.margins: Theme.spacingM
        anchors.topMargin: Theme.spacingM
        visible: currentPreferenceIndex === 0 && NetworkService.backend === "networkmanager" && (NetworkBackendService.supportsNetworkPreference || NetworkService.usingLegacy)
    ...
    VgsListView {
        ...
        delegate: Rectangle {
            ...
            VgsActionButton {
                id: qrCodeButton
                visible: VGSBackendService.methods.includes("network.qrcode") && modelData.secured && modelData.saved && !(modelData.enterprise || false)
                anchors.right: parent.right
    ...
    Menu {
        ...
        MenuItem {
            ...
            height: networkContextMenu.showSavedOptions && (NetworkBackendService.supportsWifiAutoconnect || NetworkService.usingLegacy) ? 32 : 0
            visible: networkContextMenu.showSavedOptions && (NetworkBackendService.supportsWifiAutoconnect || NetworkService.usingLegacy)
