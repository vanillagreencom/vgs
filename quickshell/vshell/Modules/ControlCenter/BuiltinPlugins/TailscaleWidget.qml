                        ...
                        Column {
                            ...
                            VgsDropdown {
                                ...
                                onValueChanged: value => {
                                    ...
                                    if (peer)
                                        TailscaleService.setExitNode(TailscaleService.exitNodeTarget(peer), null);
                                }
                            }
                                    ...
                                    Column {
                                        ...
                                        RowLayout {
                                            ...
                                            VgsActionButton {
                                                ...
                                                onClicked: Quickshell.execDetached([Paths.vshellCli, "cl", "copy", modelData.tailscaleIp])
                                            }
                                        }
                                        ...
                                        Column {
                                            ...
                                            RowLayout {
                                                ...
                                                VgsActionButton {
                                                    ...
                                                    iconSize: 11
                                                    iconColor: Theme.surfaceVariantText
                                                    onClicked: Quickshell.execDetached([Paths.vshellCli, "cl", "copy", modelData.dnsName])
                                                }
                                            }
