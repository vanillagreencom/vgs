...
Column {
    ...
    Component.onCompleted: {
        if (PluginService.isPluginLoaded("vgsNotepadModule")) {
            pluginHighlightedHtml = SettingsData.getBuiltInPluginSetting("vgsNotepadModule", "highlightedHtml", "");
        }
    }
    ...
    function syncContentToPlugin() {
        ...
        if (content === lastPluginContent && SettingsData.getBuiltInPluginSetting("vgsNotepadModule", "previewActive", false) === inlinePreviewVisible) {
            return;
        }

        lastPluginContent = content;
        SettingsData.setBuiltInPluginSetting("vgsNotepadModule", "previewActive", inlinePreviewVisible);
        SettingsData.setBuiltInPluginSetting("vgsNotepadModule", "currentFilePath", filePath);
        SettingsData.setBuiltInPluginSetting("vgsNotepadModule", "currentFileExtension", ext);
        SettingsData.setBuiltInPluginSetting("vgsNotepadModule", "sourceContent", content);
        SettingsData.setBuiltInPluginSetting("vgsNotepadModule", "updatedAt", Date.now());
    }
    ...
    Component {
        ...
        Process {
            ...
            command: ["sh", "-c", "printf '%s' \"$CONTENT\" | vshell cl copy"]
            environment: ({
                    "CONTENT": content
                })
        }
    ...
    Column {
        ...
        Item {
            ...
            Row {
                ...
                Row {
                    spacing: Theme.spacingS
                    visible: PluginService.isPluginLoaded("vgsNotepadModule")
                    VgsActionButton {
