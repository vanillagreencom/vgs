...
Rectangle {
    ...
    readonly property real expandedControlsTopMargin: cardPadding + ((compactMode ? 32 : 40) - fixedControlsHeight) / 2
    readonly property real contentRightInset: Theme.spacingL + fixedControlsWidth + Theme.spacingS
    ...
    readonly property real collapsedContentHeight: Math.max(iconSize, collapsedTextColumn.implicitHeight)
    readonly property real baseCardHeight: cardPadding * 2 + collapsedContentHeight + actionButtonHeight + contentSpacing

    width: parent ? parent.width : 400
    height: expanded ? (expandedContent.height + cardPadding * 2) : baseCardHeight
    readonly property real targetHeight: expanded ? (expandedContent.height + cardPadding * 2) : baseCardHeight
    ...
    Item {
        ...
        Item {
            ...
            anchors.right: parent.right
            anchors.top: parent.top
            height: collapsedTextColumn.implicitHeight
    ...
    Item {
        ...
        anchors.top: parent.top
        anchors.right: parent.right
        anchors.topMargin: expanded ? root.expandedControlsTopMargin : root.collapsedControlsTopMargin
        anchors.rightMargin: Theme.spacingL
        width: root.fixedControlsWidth
        height: root.fixedControlsHeight
