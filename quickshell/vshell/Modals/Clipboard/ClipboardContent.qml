...
Item {
    ...
    Item {
        ...
        anchors.leftMargin: Theme.popoutPadding
        anchors.rightMargin: Theme.popoutPadding
        anchors.bottomMargin: modal.showKeyboardHints ? (ClipboardConstants.keyboardHintsHeight + Theme.spacingM + Theme.popoutPadding) : Theme.popoutPadding
        clip: true
    ...
    Loader {
        ...
        anchors.leftMargin: Theme.popoutPadding
        anchors.rightMargin: Theme.popoutPadding
        anchors.bottomMargin: active ? Theme.popoutPadding : 0
