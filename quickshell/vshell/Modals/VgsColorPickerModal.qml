...
VgsModal {
    id: root
    readonly property var log: Log.scoped("VgsColorPickerModal")

    layerNamespace: "vshell:color-picker"
    ...
    function copyColorToClipboard(colorValue) {
        Quickshell.execDetached([Paths.vshellCli, "cl", "copy", colorValue]);
    ...
    function pickColorFromScreen() {
        hideInstant();
        Proc.runCommand("vgs-color-pick", [Paths.vshellCli, "color", "pick", "--json"], (output, exitCode) => {
            if (exitCode !== 0) {
                log.warn("VGS color pick exited with code:", exitCode);
                root.show();
                return;
            }
            try {
                ...
                if (result.hex) {
                    ...
                    log.warn("Failed to parse VGS color pick output: missing hex");
                    root.show();
                }
            } catch (e) {
                log.warn("Failed to parse VGS color pick JSON:", e);
                root.show();
            }
        }, 0, Proc.noTimeout);
    }
    ...
    modalWidth: 680
    modalHeight: contentLoader.item ? contentLoader.item.implicitHeight + Theme.popoutPadding * 2 : 680
                            ...
                            Row {
                                ...
                                VgsActionButton {
                                    ...
                                    onClicked: () => {
                                        ...
                                        Quickshell.execDetached([Paths.vshellCli, "cl", "copy", rgbString]);
                            ...
                            Row {
                                ...
                                VgsActionButton {
                                    ...
                                    onClicked: () => {
                                        ...
                                        Quickshell.execDetached([Paths.vshellCli, "cl", "copy", hsvString]);
