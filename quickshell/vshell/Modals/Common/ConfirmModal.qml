...
VgsModal {
    ...
    layerNamespace: "vshell:confirm-modal"
    ...
    allowStacking: true
    modalWidth: 350
    modalHeight: contentLoader.item ? contentLoader.item.implicitHeight + Theme.popoutPadding * 2 : 160
    enableShadow: true
    ...
    content: Component {
        Item {
            ...
            Column {
                ...
                anchors.topMargin: Theme.popoutPadding
                spacing: 0
