...
Item {
    id: root
    readonly property var log: Log.scoped("LauncherModal")
    ...
    readonly property bool useSpotlightBackend: SettingsData.launcherStyle === "spotlight"
    readonly property var _desiredBackend: useSpotlightBackend ? spotlightComp : standaloneComp
    ...
    // tearing down the launcher mid-animation when style changes.
