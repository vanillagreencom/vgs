...
|---|---|---|---|
| `horizon` | [jolaleye/horizon-theme-vscode, dark globals](https://github.com/jolaleye/horizon-theme-vscode/blob/master/src/dark/globals.json) | `apps/vscode-theme.json`: [themes/horizon.json](https://github.com/jolaleye/horizon-theme-vscode/blob/master/themes/horizon.json) at v2.0.2 | [MIT, © 2018 Jonathan Olaleye](https://github.com/jolaleye/horizon-theme-vscode/blob/master/LICENSE) |
| `horizon-light` | [jolaleye/horizon-theme-vscode, bright globals](https://github.com/jolaleye/horizon-theme-vscode/blob/master/src/bright/globals.json) | `apps/vscode-theme.json`: [themes/horizon-bright.json](https://github.com/jolaleye/horizon-theme-vscode/blob/master/themes/horizon-bright.json) at v2.0.2 | [MIT, © 2018 Jonathan Olaleye](https://github.com/jolaleye/horizon-theme-vscode/blob/master/LICENSE) |
