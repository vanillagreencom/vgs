...
`kendex refresh` from a plain terminal in the checkout links it for Claude Code, Codex and Pi.

## Features

- A scaffold command that judges the manifest, writes a plugin directory from templates and checks it.
