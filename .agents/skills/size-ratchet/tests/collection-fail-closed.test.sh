...
# A failed `git show` must not classify big.txt as absent and print an OK verdict.
...
# A failed count must not become an empty value that lets the gate print OK.
