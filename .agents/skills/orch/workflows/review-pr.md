...
A domain is already reviewed when its reviewer has an accepted artifact in `json_paths`: the first panel is scoped, and an unresponsive reviewer read nothing.
