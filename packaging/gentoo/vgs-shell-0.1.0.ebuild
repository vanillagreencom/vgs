...
pkg_postinst() {
	...
	optfeature "privileged actions run from the shell, sudoers validation before a drop-in is installed" app-admin/sudo
	...
	optfeature "terminal for VGS password prompts" gui-apps/foot
	...
	optfeature "terminal for VGS password prompts" x11-terms/alacritty
	optfeature "terminal for VGS password prompts" x11-terms/kitty
	optfeature "terminal for VGS password prompts" x11-terms/xterm
