...
{
    // Niri windows must not supply focus on the Hyprland path.
...
{
    // A focus-clear event empties the live value, leaving the remembered target to answer.
...
{
    // On Niri, an active toplevel is not the focus source.
