...
CEILINGS: dict[str, int] = {
    ...
    # Adopted at 4,261 B: per-channel publish commands, split out of the release
    ...
    # chroot and repository, because a loose or partial check passes against the
    # release still published.
    "project-skills/skills/vgs-distro-publish/SKILL.md": 4_700,
