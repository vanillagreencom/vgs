...
# routed around it can lose a refused dispatch with no diagnostic. A shell script is a bin/
# file whose shebang names bash or sh; the Python helper modules are outside this rule.
