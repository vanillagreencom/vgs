...
# p95 budgets in milliseconds, measured on the previous shell (VGS) on the runtime
# docs/architecture/memory.md names. v2 measures its own before its validation row asserts them.
BUDGET_P95_MS = {
    "dispatch_to_view": 15,
    "receipt_to_view": 4,
}
